...
enum ConfigItems
{
    ...
    CONFIG_ITEM_INT_FOOTSW_EFFECT5_SW,
    CONFIG_ITEM_INT_FOOTSW_EFFECT5_CC,
    CONFIG_ITEM_INT_FOOTSW_EFFECT5_VAL1,
    CONFIG_ITEM_INT_FOOTSW_EFFECT5_VAL2,
    CONFIG_ITEM_INT_FOOTSW_EFFECT6_SW,
    CONFIG_ITEM_INT_FOOTSW_EFFECT6_CC,
    CONFIG_ITEM_INT_FOOTSW_EFFECT6_VAL1,
    CONFIG_ITEM_INT_FOOTSW_EFFECT6_VAL2,
...
enum FootswitchLayouts
{
    ...
    FOOTSWITCH_LAYOUT_2X3,                // 2 rows of 3 switches, bank via 1+2 and 2+3
...
#define MAX_INTERNAL_EFFECT_FOOTSWITCHES        6
